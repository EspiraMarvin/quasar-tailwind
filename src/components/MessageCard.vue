<template>
  <div class="tw-py-2">
    <div class="tw-h-35 tw-w-auto tw-mx-8 md:tw-mx-4 lg:tw-mx-10 tw-rounded-2xl tw-bg-white hover:tw-bg-gray-200 tw-py-4 tw-px-4 md:tw-px-2 lg:tw-px-5 overflow-hidden tw-flex-grow-0 tw-flex-shrink-0">
